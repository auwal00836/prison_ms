        ...
        <div class="container">
          <div class="row flex-center">
            ...
            <div class="col-md-7 col-lg-6 mt-5 text-center text-md-start">
              <h1 class="fw-medium">NIGERIA CORRECTIONAL SERVICE<br />  <span class="fw-bold"></span></h1>
              <p class="mt-3 mb-4">This system automate the process of inmates records processing for Kaduna Correctional Center. <span class="fw-medium"> </span> </p><a class="btn btn-lg btn-danger hover-top btn-glow" href="#">Get Started </a>
            </div>
          </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-12 col-lg-4 mb-3"><a href="#"><img class="d-inline-block align-middle" src="assets/img/icons/logo.png" alt="" width="30" /><span class="d-inline-block text-1000 fs-1 ms-2 fw-medium lh-base">Invigilation Allocation System</a>
              ...
              <p class="text-400 my-3">&copy; 2021 Kaduna Polytechnic</p>
            </div>
